    ...
    public class BookAuthorConfiguration : IEntityTypeConfiguration<BookAuthor>
    {
        public void Configure(EntityTypeBuilder<BookAuthor> builder)
        {
            ...
            builder.HasData(
                ...
                new BookAuthor { BookId = Guid.Parse("23c5dbca-dba7-46ff-ae96-7b233a8ca88c"), AuthorId = 4 }, // The Hobbit - R.R. Tolkien
                new BookAuthor { BookId = Guid.Parse("1411eab8-b839-441d-a72d-2bb3cf7aa218"), AuthorId = 5 }  // Harry Potter - Agatha Christie
            );
        }
